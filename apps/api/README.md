...
flowchart TD
  ...
  subgraph Setup["1) Onboarding and Org Setup"]
    ...
    AGENTS["Create agent members from roles"]
  ...
  subgraph Runs["4) Agent Run Loop"]
    ...
    RS["RunService"]
    AI["AiService"]
    PROMPT["Build system prompt<br/>organization name + employee list + org chart<br/>role instructions + workspace scopes + tools + messaging IDs"]
