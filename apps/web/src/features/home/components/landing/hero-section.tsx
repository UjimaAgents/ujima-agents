...
export function HeroSection() {
  return (
    <section className="landing-hero-bg relative min-h-[92vh] overflow-hidden">
      <LandingContainer
        wide
        className="flex min-h-[92vh] flex-col items-center justify-center pb-20 pt-28 text-center md:pt-32"
      >
        <div className="mx-auto w-full max-w-3xl">
          <p className="landing-hero-enter text-[13px] font-medium tracking-wide text-zinc-500 dark:text-zinc-500">
            {hero.eyebrow}
          </p>
          <HeroHeadline />
