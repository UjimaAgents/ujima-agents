...
export const install = {
  ...
  description: "Install globally, then run ujima init and ujima start in your project.",
...
export const productSurfaces = [
  { title: "Web", text: "Channels, DMs, mentions, approvals.", href: "/onboarding", external: false },
  { title: "VS Code", text: "Same team inside your editor.", href: GITHUB_URL, external: true },
  { title: "CLI", text: "Init, start, and wire both surfaces.", href: GITHUB_URL, external: true },
];
