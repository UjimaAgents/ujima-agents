    ...
    <>
      <div
        ...
        className={`relative group flex gap-3 px-3 py-2.5 rounded-xl transition-all cursor-pointer select-none ${
          message.kind === "system"
            ? "rounded-lg bg-zinc-50/70 py-1.5 dark:bg-zinc-950/50"
            : active
      ...
      >
        {message.kind === "system" ? (
          <div className="flex flex-1 items-center gap-2.5 min-w-0">
            <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-violet-500/10 text-violet-600 dark:bg-violet-500/10 dark:text-violet-300">
            ...
            <div className="min-w-0 flex-1 flex items-center gap-2">
              ...
              <p className="shrink-0 text-[10px] text-zinc-400">{message.time}</p>
            </div>
          </div>
        ) : (
          <>
