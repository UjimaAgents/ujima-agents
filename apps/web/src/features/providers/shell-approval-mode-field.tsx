...
const ORG_SHELL_MODES = MEMBER_SHELL_MODE_OPTIONS.filter((o) => o.value !== "inherit").map(
  (o) => o.value as ShellApprovalMode,
);

function orgShellModeLabel(mode: ShellApprovalMode): string {
  return MEMBER_SHELL_MODE_OPTIONS.find((o) => o.value === mode)!.label;
}
