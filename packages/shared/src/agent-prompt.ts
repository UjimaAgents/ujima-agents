...
const SHARED_AGENT_SYSTEM_PROMPT_TAIL = [
  ...
  "Treat compacted summaries and memory.recall database entries as your own working memory across turns and threads. Natively save significant actions, decisions, and facts via memory.save so they are shared with your other spirits.",
...
const COLLABORATION_PROTOCOL_SHARED_BULLETS = [
  ...
  "- Treat compacted summaries as rolling memory across turns. Use memory.save to persist significant facts, decisions, and actions so that your spirits in other threads/channels natively inherit this state.",
