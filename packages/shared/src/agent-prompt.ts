...
const DELEGATION_GUIDANCE = [
  ...
  "Spawn multiple delegates with action spawn and a delegates array; track delegate_ids, then status, wait, stop, read, or send as needed. You are woken when a delegate completes.",
