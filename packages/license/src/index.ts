...
//   - the process is running from inside the monorepo (turbo.json
//     present at some ancestor of the entry script).
// The repo check matters because contributors run `bun run dev:local`
// without ever installing the published package — forcing them to mint
// a key would be hostile to development.
