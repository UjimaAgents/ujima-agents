...
export const DEFAULT_TOOL_CATALOG: Record<string, ToolCapability> = {
  ...
  'channel.pass': {
    id: 'channel.pass',
    name: 'Channel Pass',
    description: 'Silently stand down and terminate the current run without posting a visible channel message.',
    actions: ['message'],
    pathScopes: [],
    requiresApproval: false,
  },
  'channel.ack': {
    id: 'channel.ack',
    name: 'Channel Ack',
    description: 'Silently acknowledge a thread when you were addressed but have nothing substantive to add.',
    actions: ['message'],
    pathScopes: [],
    requiresApproval: false,
  },
  'channel.handoff': {
    ...
    description: 'Hand completed or in-progress work back to another member in the current thread.',
    actions: ['message'],
    pathScopes: [],
    requiresApproval: false,
  },
